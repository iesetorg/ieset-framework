# Result card — local_panel_sprint_fiscal_balance_employment_rate_20260503

**Verdict:** SUPPORTED — coef=+0.1074 (sign matches claim +), p=0.0332

## Pre-registration
- **Claim:** Across a pre-registered panel of OECD and major emerging-market economies from 1996 to 2023, stronger fiscal balances predict higher employment rates after country and year fixed effects and basic macro controls. This sprint test uses only local vintages and does not create school-scoreboard links.
...
- **Falsification test:** panel_fe_local_panel_sprint_fiscal_balance_employment_rate_20260503

## Estimate
- Method: linearmodels.PanelOLS
- Coefficient (treatment): **+0.1074**
- Std error: 0.05039
- p-value: **0.0332**
