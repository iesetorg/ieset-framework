#!/usr/bin/env python3
"""Replication wrapper for `currency_union_trade_creation`.
...
directly reproducible from engine/runs/currency_union_trade_creation/.
"""
...
HYPOTHESIS_ID = 'currency_union_trade_creation'
