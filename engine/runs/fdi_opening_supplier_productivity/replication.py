#!/usr/bin/env python3
"""Replication wrapper for `fdi_opening_supplier_productivity`.
...
directly reproducible from engine/runs/fdi_opening_supplier_productivity/.
"""
...
HYPOTHESIS_ID = "fdi_opening_supplier_productivity"
