#!/usr/bin/env python3
"""Replication wrapper for `regulatory_quality_fdi_spillover`.
...
directly reproducible from engine/runs/regulatory_quality_fdi_spillover/.
"""
...
HYPOTHESIS_ID = 'regulatory_quality_fdi_spillover'
