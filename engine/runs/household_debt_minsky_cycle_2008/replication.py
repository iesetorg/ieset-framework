#!/usr/bin/env python3
"""Replication wrapper for `household_debt_minsky_cycle_2008`.
...
directly reproducible from engine/runs/household_debt_minsky_cycle_2008/.
"""
...
HYPOTHESIS_ID = 'household_debt_minsky_cycle_2008'
