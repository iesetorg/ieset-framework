# Result card — uzbekistan_growth_health_services_shift_1990_2023
...
|---|---|:---:|---:|---|---|
| 1 | real_gdp_pc_growth_sustained | MET | 2.65 (2023) [average_annual_growth_rate_value] | `average annual growth >= 2.5%` | average annual growth 1990-2023 = 2.652; threshold >=2.5 |
| 2 | under5_mortality_decline_large | MET | 80.4 (2023) [peak_to_trough_pct_decline] | `>= 75% decline` |  |
| 3 | life_expectancy_gain_large | MET | 10.1 (2023) [pct_increase_from_baseline] | `>= 10% increase` |  |
| 4 | services_employment_share_high | MET | 50.6 (2019) [max_in_window] | `>= 45% during 2019` |  |
