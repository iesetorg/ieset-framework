# Result card — market_order_fiscal_balance_private_investment_share_panel

**Verdict:** SUPPORTED — coef=+0.2315 (sign matches claim +), p=0.0778

## Pre-registration
- **Claim:** Across a pre-registered narrower OECD/market-peer panel from 1996 to 2021, stronger fiscal balances predict higher private fixed-investment shares after country and year fixed effects and basic macro controls. This tests the crowding-out, risk-premium, and fiscal-expectations channels as a second-wave market-order hypothesis rather than reusing the Heritage latest-year cross-section.
...
- **Falsification test:** panel_fe_market_order_fiscal_balance_private_investment_share_panel

## Estimate
- Method: linearmodels.PanelOLS
- Coefficient (treatment): **+0.2315**
- Std error: 0.1297
- p-value: **0.0778**
- Observations: 122, countries: 5
- Within R²: -0.151
