...
## Variables resolved
- `world_bank_wdi:SL.TLF.CACT.FE.ZS` → female_lfp (controls, publisher=world_bank_wdi, n=8338)

### Variables missing data
- `oecd:OECD.ELS.SAE,DSD_EARNINGS@DF_GENDER_WAGE_GAP,1.0` (outcome, name=median_gender_pay_gap) — vintage not on disk
- `world_bank_wdi:SE.TER.CUAT.BA.FE.ZS` (controls, name=tertiary_attainment_female) — vintage not on disk
