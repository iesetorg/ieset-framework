# Result card — sri_lanka_growth_health_services_shift_1990_2023
...
|---|---|:---:|---:|---|---|
| 1 | real_gdp_pc_growth_sustained | MET | 3.36 (2023) [average_annual_growth_rate_value] | `average annual growth >= 3.0%` | average annual growth 1990-2023 = 3.363; threshold >=3 |
| 2 | under5_mortality_decline_large | MET | 79 (2023) [peak_to_trough_pct_decline] | `>= 70% decline` |  |
| 3 | life_expectancy_gain_large | MET | 11.9 (2023) [pct_increase_from_baseline] | `>= 10% increase` |  |
| 4 | services_employment_share_high | MET | 47.1 (2019) [max_in_window] | `>= 45% during 2019` |  |
...
See `hypotheses/steelman/sri_lanka_growth_health_services_shift_1990_2023.md` for the strongest opposing arguments. Canonical-case multi-metric evidence is a pattern match, not a causal identification — the result card should be read as 'outcome trajectory matches the predicted pattern to degree X' rather than 'policy P caused the outcome'.
