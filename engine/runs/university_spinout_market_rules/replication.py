#!/usr/bin/env python3
"""Replication wrapper for `university_spinout_market_rules`.
...
directly reproducible from engine/runs/university_spinout_market_rules/.
"""
...
HYPOTHESIS_ID = 'university_spinout_market_rules'
