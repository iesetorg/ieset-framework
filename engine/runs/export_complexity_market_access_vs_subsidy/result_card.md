...
**Verdict:** INCONCLUSIVE_DATA_PENDING — no outcome variable loaded; missing: ['constructed: Atlas of Economic Complexity (Harvard CID)', 'un_comtrade:export_product_concentration']
...
## Estimate
- _Error:_ no outcome variable loaded; missing: ['constructed: Atlas of Economic Complexity (Harvard CID)', 'un_comtrade:export_product_concentration']
...
- `un_comtrade:export_product_concentration` (outcome, name=export_diversification_theil) — vintage not on disk
...
_Generated by `scripts/run_panel_fe.py` at 2026-05-03T05:56:42+00:00_
