#!/usr/bin/env python3
"""Replication wrapper for `innovation_qol_market_spillovers`.
...
directly reproducible from engine/runs/innovation_qol_market_spillovers/.
"""
...
HYPOTHESIS_ID = 'innovation_qol_market_spillovers'
