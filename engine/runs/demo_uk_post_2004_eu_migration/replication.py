#!/usr/bin/env python3
"""Replication wrapper for `demo_uk_post_2004_eu_migration`.
...
directly reproducible from engine/runs/demo_uk_post_2004_eu_migration/.
"""
