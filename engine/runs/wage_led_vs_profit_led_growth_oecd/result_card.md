...
**Verdict:** INCONCLUSIVE_DATA_PENDING — treatment 'labour_share_gross_value_added' not loaded; missing: ['oecd:OECD.SDD.NAD,DSD_NAMAIN1@DF_TABLE1,1.0']
...
## Estimate
- _Error:_ treatment 'labour_share_gross_value_added' not loaded; missing: ['oecd:OECD.SDD.NAD,DSD_NAMAIN1@DF_TABLE1,1.0']

## Variables resolved
- `world_bank_wdi:NY.GDP.MKTP.KD.ZG` → aggregate_demand_growth (outcome, publisher=world_bank_wdi, n=13961)
...
- `world_bank_wdi:NE.CON.PRVT.ZS` (outcome, name=private_consumption_share_gdp) — vintage not on disk
- `world_bank_wdi:NE.RSB.GNFS.ZS` (outcome, name=net_exports_share_gdp) — vintage not on disk
- `oecd:OECD.SDD.NAD,DSD_NAMAIN1@DF_TABLE1,1.0` (treatment, name=labour_share_gross_value_added) — vintage not on disk
