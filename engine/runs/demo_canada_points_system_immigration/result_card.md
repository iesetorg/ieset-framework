...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'foreign_born_tertiary_share' not loaded; missing: ['oecd:OECD.ELS.IMM,DSD_DIOC@DF_DIOC,1.0']
...
## Estimate
- _Error:_ outcome 'foreign_born_tertiary_share' not loaded; missing: ['oecd:OECD.ELS.IMM,DSD_DIOC@DF_DIOC,1.0']
...
- `constructed: indicator = 1 for CAN; CAN = points-system reference; comparators = 0 unless they introduced equivalent points systems.` (treatment, name=points_system_indicator) — vintage not on disk
