...
- `fred:THREEFYTP10` → ny_fed_acm_term_premium_10y (outcome, publisher=fred, n=37)
- `fred:MORTGAGE30US` → mortgage_30y_rate (outcome, publisher=fred, n=56)
- `fred:MORTGAGE30US; fred:DGS10` → mortgage_treasury_spread (outcome, publisher=fred, n=56)
- `fred:WALCL` → fed_balance_sheet_walcl (treatment, publisher=fred, n=25)
- `fred:DFEDTARU` → fed_funds_target (treatment, publisher=fred, n=19)
- `fred:MTSDS133FMS` → treasury_issuance_pace (controls, publisher=fred, n=47)
...
_Generated by `scripts/run_event_study.py` at 2026-05-01T08:59:30+00:00_