...
### Missing data
- `bls:LNS12300012 (national teen); bls:LAU (state-level teen employment-population ratio)` (outcome)
- `bls:CES (accommodation + food services state-level employment)` (outcome)
