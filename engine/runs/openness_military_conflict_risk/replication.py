#!/usr/bin/env python3
"""Replication wrapper for `openness_military_conflict_risk`.
...
directly reproducible from engine/runs/openness_military_conflict_risk/.
"""
...
HYPOTHESIS_ID = 'openness_military_conflict_risk'
