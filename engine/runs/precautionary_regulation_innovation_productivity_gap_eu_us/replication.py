#!/usr/bin/env python3
"""Replication wrapper for `precautionary_regulation_innovation_productivity_gap_eu_us`.
...
HYPOTHESIS_ID = 'precautionary_regulation_innovation_productivity_gap_eu_us'
