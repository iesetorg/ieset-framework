...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'citizen_protection_proxy_gdpr_reach_ai_act' not loaded
...
- _Error:_ outcome 'citizen_protection_proxy_gdpr_reach_ai_act' not loaded

## Variables resolved
- `eurostat:rd_e_gerdreg; oecd:research_and_development_statistics` → rd_investment_per_gdp (outcome, n=11893)
