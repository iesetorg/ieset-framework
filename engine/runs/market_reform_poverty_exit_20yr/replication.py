#!/usr/bin/env python3
"""Replication wrapper for `market_reform_poverty_exit_20yr`.
...
directly reproducible from engine/runs/market_reform_poverty_exit_20yr/.
"""
...
HYPOTHESIS_ID = 'market_reform_poverty_exit_20yr'
