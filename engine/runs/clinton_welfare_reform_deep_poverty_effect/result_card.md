...
## Variables resolved
- `world_bank_wdi:SI.POV.DDAY` → deep_poverty_rate_single_parent_households (outcome, publisher=world_bank_wdi, n=2906)
...
_Generated by `scripts/run_event_study.py` at 2026-04-27T10:41:10+00:00_