...
**Verdict:** PARTIAL — coef=-0.03123, p=0.173 (above α=0.10); direction inconclusive
...
- `oecd:OECD.ELS.SAE,DSD_TUD_CBC@DF_TUD,1.0` (controls, name=union_density) — vintage not on disk
- `oecd:OECD.SDD.NAD,DSD_NAMAIN1@DF_TABLE3,1.0` (controls, name=financial_sector_va_share) — vintage not on disk

_Generated by `scripts/run_panel_fe.py` at 2026-04-30T12:29:42+00:00_