#!/usr/bin/env python3
"""Replication wrapper for `welfare_transfer_argentina_auh_2009_child_poverty_effect`.
...
directly reproducible from engine/runs/welfare_transfer_argentina_auh_2009_child_poverty_effect/.
"""
