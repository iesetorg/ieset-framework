#!/usr/bin/env python3
"""Replication wrapper for `incumbent_subsidy_innovation_drag`.
...
directly reproducible from engine/runs/incumbent_subsidy_innovation_drag/.
"""
...
HYPOTHESIS_ID = 'incumbent_subsidy_innovation_drag'
