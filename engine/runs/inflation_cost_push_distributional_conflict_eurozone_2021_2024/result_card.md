...
**Verdict:** INCONCLUSIVE_DATA_PENDING — treatment 'terms_of_trade_shock' not loaded; missing: ['eurostat:bop_external; ecb:terms_of_trade_index', 'eurostat:nrg_pc; ecb:energy_commodity_prices', 'ecb:FM.D.U2.EUR.4F.KR.MRR_FR.LEV']
...
## Estimate
- _Error:_ treatment 'terms_of_trade_shock' not loaded; missing: ['eurostat:bop_external; ecb:terms_of_trade_index', 'eurostat:nrg_pc; ecb:energy_commodity_prices', 'ecb:FM.D.U2.EUR.4F.KR.MRR_FR.LEV']

## Variables resolved
- `eurostat:nama_10_gdp; ecb:MNA.Q.N.U2.W2.S1.S1.B.B1GQ._Z._Z._Z.IX.D.N` → gdp_deflator_yoy (outcome, publisher=eurostat, n=1452)
- `eurostat:earn_nt_net; oecd:real_average_wage` → real_wage_index (outcome, publisher=eurostat, n=867)
- `ecb:ICP.M.U2.N.000000.4.ANR; eurostat:HICP` → hicp_inflation_yoy (outcome, publisher=ecb, n=29)
...
- `eurostat:nrg_pc; ecb:energy_commodity_prices` (treatment, name=gas_import_price_index) — vintage not on disk
...
- `eurostat:lfsa_urgan; ilostat:unemployment_rate` (controls, name=unemployment_rate) — vintage not on disk
