...
## Estimate
- _Error:_ no outcome variable loaded; missing: ['academic:psid_cex_consumption_microdata', 'academic:psid_cex_consumption_microdata']
...
- `world_bank_wdi:NY.GDP.PCAP.KD` (controls, name=gdp_per_capita_real) — vintage not on disk
