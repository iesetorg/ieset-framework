#!/usr/bin/env python3
"""Replication wrapper for `education_quality_trade_openness`.
...
directly reproducible from engine/runs/education_quality_trade_openness/.
"""
...
HYPOTHESIS_ID = 'education_quality_trade_openness'
