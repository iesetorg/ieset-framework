...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'finance_insurance_va_share_gdp' not loaded; missing: ['oecd:OECD.SDD.NAD,DSD_NAMAIN1@DF_TABLE3,1.0']
...
## Estimate
- _Error:_ outcome 'finance_insurance_va_share_gdp' not loaded; missing: ['oecd:OECD.SDD.NAD,DSD_NAMAIN1@DF_TABLE3,1.0']

## Variables resolved
- `world_bank_wdi:NV.IND.MANF.ZS` → manufacturing_va_share_gdp (outcome, publisher=world_bank_wdi, n=9749)
...
- `world_bank_wdi:NV.SRV.TOTL.ZS` → services_total_va_share (controls, publisher=world_bank_wdi, n=10395)
...
- `dates:financialisation_era_post_1980` (treatment, name=post_1980_indicator) — vintage not on disk
