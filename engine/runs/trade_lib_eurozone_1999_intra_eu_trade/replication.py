#!/usr/bin/env python3
"""Replication wrapper for `trade_lib_eurozone_1999_intra_eu_trade`.
...
directly reproducible from engine/runs/trade_lib_eurozone_1999_intra_eu_trade/.
"""
...
HYPOTHESIS_ID = 'trade_lib_eurozone_1999_intra_eu_trade'
