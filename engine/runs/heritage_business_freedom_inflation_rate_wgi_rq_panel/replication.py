...
SPEC = {
    "hypothesis_id": "heritage_business_freedom_inflation_rate_wgi_rq_panel",
    "source_rank": 17,
    "source_hypothesis_id": "heritage_business_freedom_inflation_rate_income_region_robustness",
    "source_controlled_verdict": "SUPPORTED",
    "source_bh_q_value": 0.0004647595345020366,
    "source_run_path": "engine/runs/heritage_business_freedom_inflation_rate_income_region_robustness",
    "proxy_kind": "single",
    ...
    "outcome_label": "annual CPI inflation",
    "expected_sign": "-",
}
