#!/usr/bin/env python3
"""Replication wrapper for `demo_us_hart_celler_1965_legacy`.
...
directly reproducible from engine/runs/demo_us_hart_celler_1965_legacy/.
"""
...
HYPOTHESIS_ID = 'demo_us_hart_celler_1965_legacy'
