...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'systemic_banking_crisis_onset' not loaded; missing: ['owid:systemic-banking-crises']
...
## Estimate
- _Error:_ outcome 'systemic_banking_crisis_onset' not loaded; missing: ['owid:systemic-banking-crises']

## Variables resolved
- `world_bank_wdi:FS.AST.PRVT.GD.ZS; bis:WS_TC` → private_credit_to_gdp (treatment, publisher=world_bank_wdi, n=9627)
...
- `world_bank_wdi:FI.RES.TOTL.MO; imf:NGDPDPC` → reserves_to_short_term_external_debt (treatment, publisher=imf, n=10873)
...
- `wgi:GOV_WGI_RQ.EST` → wgi_regulatory_quality (controls, publisher=wgi, n=5195)

### Variables missing data
- `owid:systemic-banking-crises` (outcome, name=systemic_banking_crisis_onset) — vintage not on disk
