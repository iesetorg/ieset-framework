...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'real_disposable_income_growth_by_quintile' not loaded; missing: ['oecd:distributional_national_accounts; lis:disposable_income_quintile (manual)', 'oecd:distributional_national_accounts; eurostat:icw_sr_05', 'ecb:HFCS; oecd:OECD_AffordableHousing; fred:HHDFA (USA)']
...
## Estimate
- _Error:_ outcome 'real_disposable_income_growth_by_quintile' not loaded; missing: ['oecd:distributional_national_accounts; lis:disposable_income_quintile (manual)', 'oecd:distributional_national_accounts; eurostat:icw_sr_05', 'ecb:HFCS; oecd:OECD_AffordableHousing; fred:HHDFA (USA)']

## Variables resolved
- `eurostat:ilc_lvho07c; bls:CES (USA)` → rent_to_income_ratio_by_quintile (outcome, publisher=bls, n=3)
- `fred:DFF (USA); ecb:FM (EUR); boe:bank_rate (GBR)` → cumulative_policy_rate_change (treatment, publisher=fred, n=73)
- `world_bank_wdi:NY.GDP.MKTP.KD.ZG` → real_gdp_growth (controls, publisher=world_bank_wdi, n=13961)
- `fred:CPIAUCSL (USA); ecb:HICP (EUR); boe:CPI (GBR)` → cpi_inflation_yoy (controls, publisher=fred, n=80)
...
- `oecd:distributional_national_accounts; eurostat:icw_sr_05` (outcome, name=net_interest_income_share_by_quintile) — vintage not on disk
- `ecb:HFCS; oecd:OECD_AffordableHousing; fred:HHDFA (USA)` (outcome, name=mortgage_payment_to_income_ratio) — vintage not on disk
- `constructed: indicator = 1 from 2022Q3 (Fed/ECB) or 2021Q4 (BoE) through 2024Q4` (treatment, name=tightening_cycle_indicator) — vintage not on disk
- `ilostat:unemployment_rate; eurostat:lfsa_urgan` (controls, name=unemployment_rate_by_quintile) — vintage not on disk
