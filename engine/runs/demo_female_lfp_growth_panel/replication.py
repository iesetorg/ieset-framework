#!/usr/bin/env python3
"""Replication wrapper for `demo_female_lfp_growth_panel`.
...
directly reproducible from engine/runs/demo_female_lfp_growth_panel/.
"""
...
HYPOTHESIS_ID = 'demo_female_lfp_growth_panel'
