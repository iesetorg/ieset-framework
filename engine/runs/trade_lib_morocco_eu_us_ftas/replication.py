#!/usr/bin/env python3
"""Replication wrapper for `trade_lib_morocco_eu_us_ftas`.
...
directly reproducible from engine/runs/trade_lib_morocco_eu_us_ftas/.
"""
...
HYPOTHESIS_ID = 'trade_lib_morocco_eu_us_ftas'
