#!/usr/bin/env python3
"""Replication wrapper for `trade_lib_evfta_vietnam_eu_2020`.
...
directly reproducible from engine/runs/trade_lib_evfta_vietnam_eu_2020/.
"""
