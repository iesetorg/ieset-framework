...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'services_cpi_state_level' not loaded; missing: ['bls:cpi_services_subindex', 'bls:ces_state_employment']
...
## Estimate
- _Error:_ outcome 'services_cpi_state_level' not loaded; missing: ['bls:cpi_services_subindex', 'bls:ces_state_employment']
...
- `bls:cps_licensing_supplement` (treatment, name=licensing_intensity_state) — vintage not on disk
