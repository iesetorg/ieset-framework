# Result card — ml_rule_bound_regulation_investment_volatility

**Verdict:** PARTIAL — coef=+0.5618, p=0.249 (above α=0.1); direction inconclusive

## Pre-registration
- **Claim:** stable rule-bound regulation predicts higher private investment and lower investment volatility than discretionary licensing or case-by-case industrial policy.
...
- **Falsification test:** panel_fe_ml_rule_bound_regulation_investment_volatility
...
_Generated by `scripts/run_panel_fe.py` at 2026-05-22T17:54:28+00:00_