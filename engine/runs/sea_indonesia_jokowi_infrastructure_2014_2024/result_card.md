...
**Verdict:** REFUTED — coef=-1.197 (sign opposite claim +), p=1.22e-05
...
- `constructed: indicator = 1 for IDN, year >= 2014` (treatment, name=post_jokowi_indicator) — vintage not on disk
