#!/usr/bin/env python3
"""Replication wrapper for `health_qol_market_broad_scope`.
...
directly reproducible from engine/runs/health_qol_market_broad_scope/.
"""
...
HYPOTHESIS_ID = 'health_qol_market_broad_scope'
