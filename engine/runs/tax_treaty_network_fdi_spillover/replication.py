#!/usr/bin/env python3
"""Replication wrapper for `tax_treaty_network_fdi_spillover`.
...
directly reproducible from engine/runs/tax_treaty_network_fdi_spillover/.
"""
...
HYPOTHESIS_ID = 'tax_treaty_network_fdi_spillover'
