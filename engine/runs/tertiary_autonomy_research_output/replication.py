#!/usr/bin/env python3
"""Replication wrapper for `tertiary_autonomy_research_output`.
...
directly reproducible from engine/runs/tertiary_autonomy_research_output/.
"""
...
HYPOTHESIS_ID = 'tertiary_autonomy_research_output'
