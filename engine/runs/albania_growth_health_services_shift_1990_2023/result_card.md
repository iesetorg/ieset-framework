...
|---|---|:---:|---:|---|---|
| 1 | real_gdp_pc_growth_sustained | MET | 3.88 (2023) [average_annual_growth_rate_value] | `average annual growth >= 3.5%` | average annual growth 1990-2023 = 3.878; threshold >=3.5 |
| 2 | under5_mortality_decline_large | MET | 77.1 (2017) [peak_to_trough_pct_decline] | `>= 70% decline` |  |
| 3 | life_expectancy_gain_large | MET | 9.48 (2023) [pct_increase_from_baseline] | `>= 8% increase` |  |
| 4 | services_employment_share_high | MET | 43.2 (2019) [max_in_window] | `>= 40% during 2019` |  |
