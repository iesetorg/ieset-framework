...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'sectoral_value_added_log' not loaded
...
- _Error:_ outcome 'sectoral_value_added_log' not loaded

## Variables resolved
- `world_bank_wdi:TT.PRI.MRCH.XD.WD; imf_pcps:Primary` → commodity_terms_of_trade (controls, n=6478)
- `bis:WS_EER` → brazil_real_exchange_rate (controls, n=2922)
