# Result card — south_korea_growth_health_services_shift_1990_2023
...
|---|---|:---:|---:|---|---|
| 1 | real_gdp_pc_growth_sustained | MET | 4.28 (2023) [average_annual_growth_rate_value] | `average annual growth >= 3.5%` | average annual growth 1990-2023 = 4.284; threshold >=3.5 |
| 2 | under5_mortality_decline_large | MET | 81.5 (2022) [peak_to_trough_pct_decline] | `>= 75% decline` |  |
| 3 | life_expectancy_gain_large | MET | 16.7 (2021) [pct_increase_from_baseline] | `>= 15% increase` |  |
| 4 | services_employment_share_high | MET | 70.3 (2019) [max_in_window] | `>= 65% during 2019` |  |
