#!/usr/bin/env python3
"""Replication wrapper for `market_entry_small_business_jobs`.
...
directly reproducible from engine/runs/market_entry_small_business_jobs/.
"""
...
HYPOTHESIS_ID = 'market_entry_small_business_jobs'
