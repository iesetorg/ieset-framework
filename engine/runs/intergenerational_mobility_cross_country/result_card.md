...
- Found on-disk: 7 of 9.
- Missing outcome: ['owid:share-of-children-in-the-bottom-quintile-who-make-it-to-the-top-quintile'].
- Binding missing series: ['oecd:OECD.EDU.IMEP_DSD_EAG_FIN_DF_FIN_RESOURCES_1.0'].
- Missing channels: ['oecd:OECD.EDU.IMEP_DSD_EAG_FIN_DF_FIN_RESOURCES_1.0'].
...
- `oecd:OECD.ELS.HD_DSD_HH_DASH_DF_HSG_INEQ_1.0` — available
