...
**Verdict:** INCONCLUSIVE_DATA_PENDING — no treatment variable resolved
...
## Estimate
- _Error:_ no treatment variable resolved
...
- `constructed:privatisation_event_database` (treatment, name=privatisation_indicator)
- `constructed:oecd_regulatory_governance_index` (treatment, name=regulatory_independence_index)
...
_Generated by `scripts/run_event_study.py` at 2026-05-03T06:49:27+00:00_
