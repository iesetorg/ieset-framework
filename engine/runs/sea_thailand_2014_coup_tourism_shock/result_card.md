...
**Verdict:** REFUTED — coef=-0.9732 (sign opposite claim +), p=0.0341
...
- `constructed: indicator = 1 for THA, year >= 2014` (treatment, name=post_2014_coup_indicator) — vintage not on disk
