...
- `constructed: police-recorded offence rates per 100k by nativity (foreign-born vs native-born) and offence type (violent / property / drug / public order). Destination-country admin data — SCB Sweden, BKA Germany, ONS England-Wales, FBI UCR US (with caveats), CBS Netherlands.` (outcome, name=crime_rate_per_capita_by_nativity_and_offence) — vintage not on disk
