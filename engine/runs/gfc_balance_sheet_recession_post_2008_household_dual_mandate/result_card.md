...
**Verdict:** INCONCLUSIVE_DATA_PENDING — treatment 'household_saving_rate' not loaded; missing: ['oecd:OECD.SDD.NAD,DSD_NASEC_T7HH@DF_T7HH,1.0', 'bis:WS_TC', 'oecd:OECD.SDD.NAD,DSD_NASEC_T7NF@DF_T7NF,1.0', 'world_bank_wdi:GC.NLD.TOTL.GD.ZS']
...
## Estimate
- _Error:_ treatment 'household_saving_rate' not loaded; missing: ['oecd:OECD.SDD.NAD,DSD_NASEC_T7HH@DF_T7HH,1.0', 'bis:WS_TC', 'oecd:OECD.SDD.NAD,DSD_NASEC_T7NF@DF_T7NF,1.0', 'world_bank_wdi:GC.NLD.TOTL.GD.ZS']

## Variables resolved
- `world_bank_wdi:NY.GDP.MKTP.KD.ZG` → cumulative_real_gdp_change_2007_2014 (outcome, publisher=world_bank_wdi, n=13961)
...
- `bis:WS_TC` (treatment, name=household_debt_disposable_income) — vintage not on disk
...
- `bis:WS_TC` (controls, name=pre_crisis_household_credit_gdp) — vintage not on disk
