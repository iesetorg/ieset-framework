...
SPEC = {
    "hypothesis_id": "heritage_business_freedom_electricity_access_wgi_rq_panel",
    "source_rank": 16,
    "source_hypothesis_id": "heritage_business_freedom_electricity_access_income_region_robustness",
    "source_controlled_verdict": "SUPPORTED",
    "source_bh_q_value": 0.00042999740027875247,
    "source_run_path": "engine/runs/heritage_business_freedom_electricity_access_income_region_robustness",
    "proxy_kind": "single",
    ...
    "outcome_label": "access to electricity (% of population)",
    "expected_sign": "+",
}
