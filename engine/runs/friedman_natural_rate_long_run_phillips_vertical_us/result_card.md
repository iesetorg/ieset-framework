...
**Verdict:** PARTIAL — coef=+1.765, p=1 (above α=0.10); direction inconclusive
...
- `fred:M2SL; fred:GDPC1` → decade_mean_m2_growth_minus_real_gdp_growth (treatment, publisher=fred, n=79)
- `fred:GDPC1` → trend_output_growth (controls, publisher=fred, n=79)
- `fred:FEDFUNDS` → short_term_interest_rate (controls, publisher=fred, n=73)

### Variables missing data
- `fred:WTISPLC` (controls, name=oil_price_change_decade) — vintage not on disk
