#!/usr/bin/env python3
"""Replication wrapper for `digital_education_market_entry`.
...
directly reproducible from engine/runs/digital_education_market_entry/.
"""
...
HYPOTHESIS_ID = 'digital_education_market_entry'
