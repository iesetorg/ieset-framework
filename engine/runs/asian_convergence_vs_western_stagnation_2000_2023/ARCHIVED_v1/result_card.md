...
**Verdict:** partial — gap +0.74 log-points (threshold >= 0.30), conditional-convergence coef -0.037 (p=0.720)
...
Growth gap +0.74 log-points is below the 0.30 pre-registered threshold. Conditional-convergence coefficient on Asian dummy is -0.037 (p=0.720).
