...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'teen_employment_to_population_ratio_high_bite' not loaded
...
- _Error:_ outcome 'teen_employment_to_population_ratio_high_bite' not loaded

## Variables resolved
- `world_bank_wdi:NY.GDP.MKTP.KD (national-level proxy when sub-national series unavailable)` → regional_gdp_growth (controls, n=14131)
