#!/usr/bin/env python3
"""Replication wrapper for `free_banking_historical_stability`.
...
directly reproducible from engine/runs/free_banking_historical_stability/.
"""
...
HYPOTHESIS_ID = 'free_banking_historical_stability'
