#!/usr/bin/env python3
"""Replication wrapper for `demo_france_pied_noir_absorption`.
...
directly reproducible from engine/runs/demo_france_pied_noir_absorption/.
"""
...
HYPOTHESIS_ID = 'demo_france_pied_noir_absorption'
