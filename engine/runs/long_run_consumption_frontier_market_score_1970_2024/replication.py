#!/usr/bin/env python3
"""Replication wrapper for `long_run_consumption_frontier_market_score_1970_2024`.
...
directly reproducible from engine/runs/long_run_consumption_frontier_market_score_1970_2024/.
"""
