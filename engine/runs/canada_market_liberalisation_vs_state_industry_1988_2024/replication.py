#!/usr/bin/env python3
"""Replication wrapper for `canada_market_liberalisation_vs_state_industry_1988_2024`.
...
HYPOTHESIS_ID = 'canada_market_liberalisation_vs_state_industry_1988_2024'
