#!/usr/bin/env python3
"""Replication wrapper for `pharma_price_control_launch_delay`.
...
directly reproducible from engine/runs/pharma_price_control_launch_delay/.
"""
...
HYPOTHESIS_ID = 'pharma_price_control_launch_delay'
