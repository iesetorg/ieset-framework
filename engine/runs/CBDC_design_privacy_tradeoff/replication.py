#!/usr/bin/env python3
"""Replication wrapper for `CBDC_design_privacy_tradeoff`.
...
directly reproducible from engine/runs/CBDC_design_privacy_tradeoff/.
"""
...
HYPOTHESIS_ID = 'CBDC_design_privacy_tradeoff'
