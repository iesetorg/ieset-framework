#!/usr/bin/env python3
"""Replication wrapper for `human_capital_market_reform_lag`.
...
directly reproducible from engine/runs/human_capital_market_reform_lag/.
"""
...
HYPOTHESIS_ID = 'human_capital_market_reform_lag'
