...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'sector_labour_productivity' not loaded; missing: ['bls:productivity_major_sector_industry', 'fred:OPHNFB; fred:OPHPBS']
...
## Estimate
- _Error:_ outcome 'sector_labour_productivity' not loaded; missing: ['bls:productivity_major_sector_industry', 'fred:OPHNFB; fred:OPHPBS']

## Variables resolved

### Variables missing data
- `bls:productivity_major_sector_industry` (outcome, name=sector_labour_productivity) — vintage not on disk
- `fred:OPHNFB; fred:OPHPBS` (outcome, name=real_output_per_hour) — vintage not on disk
...
- `constructed: 1 from 2022-12 onwards` (treatment, name=post_chatgpt_indicator) — vintage not on disk
