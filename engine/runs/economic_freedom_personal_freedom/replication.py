#!/usr/bin/env python3
"""Replication wrapper for `economic_freedom_personal_freedom`.
...
directly reproducible from engine/runs/economic_freedom_personal_freedom/.
"""
...
HYPOTHESIS_ID = "economic_freedom_personal_freedom"
