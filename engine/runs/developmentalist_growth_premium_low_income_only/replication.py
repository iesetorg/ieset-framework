#!/usr/bin/env python3
"""Replication wrapper for `developmentalist_growth_premium_low_income_only`.
...
directly reproducible from engine/runs/developmentalist_growth_premium_low_income_only/.
"""
