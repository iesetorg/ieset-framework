...
**Verdict:** INCONCLUSIVE_DATA_PENDING — no treatment variable loaded; missing: ['oecd_social_expenditure:public_social_expenditure', 'constructed: composite of OECD PMR (inverted), OECD EPL (inverted), trade openness (WDI), and debt-to-GDP (IMF, inverted above 90%)']
...
## Estimate
- _Error:_ no treatment variable loaded; missing: ['oecd_social_expenditure:public_social_expenditure', 'constructed: composite of OECD PMR (inverted), OECD EPL (inverted), trade openness (WDI), and debt-to-GDP (IMF, inverted above 90%)']
...
_Generated by `scripts/run_panel_fe.py` at 2026-05-02T15:59:37+00:00_