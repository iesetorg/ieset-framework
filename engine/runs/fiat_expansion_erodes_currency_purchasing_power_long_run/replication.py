#!/usr/bin/env python3
"""Replication wrapper for `fiat_expansion_erodes_currency_purchasing_power_long_run`.
...
directly reproducible from engine/runs/fiat_expansion_erodes_currency_purchasing_power_long_run/.
"""
