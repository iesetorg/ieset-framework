# Result card — ghana_growth_health_services_shift_1990_2023
...
|---|---|:---:|---:|---|---|
| 1 | real_gdp_pc_growth_sustained | MET | 2.71 (2023) [average_annual_growth_rate_value] | `average annual growth >= 2.5%` | average annual growth 1990-2023 = 2.711; threshold >=2.5 |
| 2 | under5_mortality_decline_large | MET | 70.8 (2023) [peak_to_trough_pct_decline] | `>= 65% decline` |  |
| 3 | life_expectancy_gain_large | MET | 18.2 (2023) [pct_increase_from_baseline] | `>= 15% increase` |  |
| 4 | services_employment_share_high | MET | 46.3 (2019) [max_in_window] | `>= 40% during 2019` |  |
