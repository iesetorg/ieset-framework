# Result card — pcw100_global_efw_trade_freedom_unemployment

- Verdict: **SUPPORTED**
- Cohort: `international_policy`
- Expected sign: `-`
- Reason: coefficient=-0.619191, SE=0.281779, p=0.0279896, expected_sign=-
- Observations: 162
- Units: 162
- Contrast: bottom treatment quartile versus top treatment quartile
- Contrast gap: 1.89309
...
- High-policy units: ARE, AUT, BEL, BGR, CAN, CHL, CRI, CYP, CZE, DEU, DNK, ESP, EST, FIN, FRA, GBR, GEO, GTM, HKG, HRV, HUN, IRL, ISR, ITA, LTU, LUX, LVA, MLT, MUS, NLD, NZL, PAN, PER, PRT, QAT, ROU, SGP, SVK, SVN, SWE, USA
...
- Coefficient: -0.61919095
- Standard error: 0.28177927
- p-value: 0.027989567
- R-squared: 0.125814
