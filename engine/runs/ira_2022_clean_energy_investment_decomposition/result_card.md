...
## Variables resolved
- `constructed: US Treasury / OMB outlay tabulations cross-checked against CBO 2022/2023/2024 reestimates. fred:FYONET (deficit baseline) + Treasury Green Book line items. Manual-drop pending.` → log_us_cumulative_clean_energy_tax_credit_outlay_usd (outcome, publisher=constructed, n=144)
...
_Generated by `scripts/run_panel_fe.py` at 2026-04-30T14:58:44+00:00_