#!/usr/bin/env python3
"""Replication wrapper for `ecuador_correa_default_2008`.
...
directly reproducible from engine/runs/ecuador_correa_default_2008/.
"""
