#!/usr/bin/env python3
"""Replication wrapper for `demo_japan_ageing_deflation_link`.
...
directly reproducible from engine/runs/demo_japan_ageing_deflation_link/.
"""
