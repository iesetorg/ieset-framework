#!/usr/bin/env python3
"""Replication wrapper for `demo_higher_ed_expansion_growth`.
...
directly reproducible from engine/runs/demo_higher_ed_expansion_growth/.
"""
...
HYPOTHESIS_ID = 'demo_higher_ed_expansion_growth'
