#!/usr/bin/env python3
"""Replication wrapper for `trade_lib_cptpp_2018_pacific_rim_trade`.
...
directly reproducible from engine/runs/trade_lib_cptpp_2018_pacific_rim_trade/.
"""
...
HYPOTHESIS_ID = 'trade_lib_cptpp_2018_pacific_rim_trade'
