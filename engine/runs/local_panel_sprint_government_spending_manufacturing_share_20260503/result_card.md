# Result card — local_panel_sprint_government_spending_manufacturing_share_20260503

**Verdict:** SUPPORTED — coef=-0.1159 (sign matches claim -), p=0.0554

## Pre-registration
- **Claim:** Across a pre-registered panel of OECD and major emerging-market economies from 1996 to 2023, larger government-expenditure shares predict lower manufacturing value-added shares after country and year fixed effects and basic macro controls. This sprint test uses only local vintages and does not create school-scoreboard links.
...
- **Falsification test:** panel_fe_local_panel_sprint_government_spending_manufacturing_share_20260503

## Estimate
- Method: linearmodels.PanelOLS
- Coefficient (treatment): **-0.1159**
- Std error: 0.06042
- p-value: **0.0554**
- Observations: 1276, countries: 51
- Within R²: -0.257
