#!/usr/bin/env python3
"""Replication wrapper for `market_innovation_broad_scope`.
...
directly reproducible from engine/runs/market_innovation_broad_scope/.
"""
...
HYPOTHESIS_ID = 'market_innovation_broad_scope'
