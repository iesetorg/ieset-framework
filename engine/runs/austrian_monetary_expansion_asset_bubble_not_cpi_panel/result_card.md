...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'real_home_price_index' not loaded; missing: ['bis:WS_LONG_PP', 'shiller:us_home_price_real; oecd:share_price_index']
...
## Estimate
- _Error:_ outcome 'real_home_price_index' not loaded; missing: ['bis:WS_LONG_PP', 'shiller:us_home_price_real; oecd:share_price_index']
...
- `bis:WS_LONG_PP` (outcome, name=real_home_price_index) — vintage not on disk
