...
**Verdict:** INCONCLUSIVE_DATA_PENDING — no treatment variable loaded; missing: ['oecd_tiva:gvc_participation', 'oecd_pmr:barriers_to_entry']
...
## Estimate
- _Error:_ no treatment variable loaded; missing: ['oecd_tiva:gvc_participation', 'oecd_pmr:barriers_to_entry']
...
- `oecd_pmr:barriers_to_entry` (treatment, name=domestic_entry_freedom_index) — vintage not on disk
...
_Generated by `scripts/run_panel_fe.py` at 2026-05-02T15:59:32+00:00_