#!/usr/bin/env python3
"""Replication wrapper for `market_reform_job_quality_panel`.
...
directly reproducible from engine/runs/market_reform_job_quality_panel/.
"""
...
HYPOTHESIS_ID = 'market_reform_job_quality_panel'
