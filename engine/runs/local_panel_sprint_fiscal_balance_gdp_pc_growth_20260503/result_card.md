# Result card — local_panel_sprint_fiscal_balance_gdp_pc_growth_20260503

**Verdict:** SUPPORTED — coef=+0.2655 (sign matches claim +), p=2.86e-07

## Pre-registration
- **Claim:** Across a pre-registered panel of OECD and major emerging-market economies from 1996 to 2023, stronger fiscal balances predict faster real GDP per capita growth after country and year fixed effects and basic macro controls. This sprint test uses only local vintages and does not create school-scoreboard links.
...
- **Falsification test:** panel_fe_local_panel_sprint_fiscal_balance_gdp_pc_growth_20260503

## Estimate
- Method: linearmodels.PanelOLS
- Coefficient (treatment): **+0.2655**
- Std error: 0.05143
- p-value: **2.86e-07**
