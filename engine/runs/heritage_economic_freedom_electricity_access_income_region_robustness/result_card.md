# Result card — heritage_economic_freedom_electricity_access_income_region_robustness

**Verdict:** PARTIAL — controlled coefficient not decisive (coef=-1.427, p=0.3392)
...
- Market-score coefficient, standardized score: `-1.426693105971387`.
- Controlled p-value: `0.33917703441542413`.
