...
**Verdict:** INCONCLUSIVE_DATA_PENDING — treatment 'occupational_licensing_scope_index' not loaded; missing: ['derived:carpenter_knepper_licensing_index']
...
## Estimate
- _Error:_ treatment 'occupational_licensing_scope_index' not loaded; missing: ['derived:carpenter_knepper_licensing_index']

## Variables resolved
- `bls:CES0500000003` → state_labour_productivity_per_hour (outcome, publisher=bls, n=3)
- `world_bank_wdi:SM.POP.TOTL` → inter_state_migration_rate (outcome, publisher=world_bank_wdi, n=2080)
- `fred:STTMINWGCA` → state_minimum_wage (controls, publisher=fred, n=59)
- `world_bank_wdi:SP.POP.TOTL` → log_state_population (controls, publisher=world_bank_wdi, n=17000)
