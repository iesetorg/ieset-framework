...
**Verdict:** INCONCLUSIVE_DATA_PENDING — no outcome variable loaded; missing: ['world_bank_wdi:IC.BUS.NREG', 'ilo:employment_by_firm_size']
...
## Estimate
- _Error:_ no outcome variable loaded; missing: ['world_bank_wdi:IC.BUS.NREG', 'ilo:employment_by_firm_size']
...
- `world_bank_wdi:IC.BUS.NREG` (outcome, name=new_business_registrations_per_1000_working_age) — vintage not on disk
...
_Generated by `scripts/run_panel_fe.py` at 2026-05-02T15:59:43+00:00_