# Result card — heritage_financial_freedom_under5_mortality_income_region_robustness

**Verdict:** PARTIAL — controlled coefficient not decisive (coef=-2.129, p=0.1158)
...
- Market-score coefficient, standardized score: `-2.128541747923737`.
- Controlled p-value: `0.1157737403808442`.
