#!/usr/bin/env python3
"""Replication wrapper for `education_qol_market_broad_sample`.
...
directly reproducible from engine/runs/education_qol_market_broad_sample/.
"""
...
HYPOTHESIS_ID = 'education_qol_market_broad_sample'
