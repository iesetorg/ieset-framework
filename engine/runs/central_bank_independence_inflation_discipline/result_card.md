...
**Verdict:** INCONCLUSIVE_DATA_PENDING — treatment 'cbi_garriga_index' not loaded; missing: ['owid:central-bank-independence-cukierman']
...
## Estimate
- _Error:_ treatment 'cbi_garriga_index' not loaded; missing: ['owid:central-bank-independence-cukierman']
...
- `wgi:GOV_WGI_GE.EST` → wgi_government_effectiveness (treatment, publisher=wgi, n=5194)
...
- `owid:central-bank-independence-cukierman` (treatment, name=cbi_garriga_index) — vintage not on disk
