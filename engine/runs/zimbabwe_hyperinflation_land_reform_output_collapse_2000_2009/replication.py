#!/usr/bin/env python3
"""Replication wrapper for `zimbabwe_hyperinflation_land_reform_output_collapse_2000_2009`.
...
HYPOTHESIS_ID = 'zimbabwe_hyperinflation_land_reform_output_collapse_2000_2009'
