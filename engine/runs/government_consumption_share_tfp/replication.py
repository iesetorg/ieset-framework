#!/usr/bin/env python3
"""Replication wrapper for `government_consumption_share_tfp`.
...
directly reproducible from engine/runs/government_consumption_share_tfp/.
"""
...
HYPOTHESIS_ID = "government_consumption_share_tfp"
