#!/usr/bin/env python3
"""Replication wrapper for `state_champion_tech_failure_rate`.
...
directly reproducible from engine/runs/state_champion_tech_failure_rate/.
"""
...
HYPOTHESIS_ID = 'state_champion_tech_failure_rate'
