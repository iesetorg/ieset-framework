...
**Verdict:** INCONCLUSIVE_DATA_PENDING — no treatment variable loaded; missing: ['constructed:exports_to_gdp_plus_export_sophistication', 'constructed:tariff_rate_plus_non_tariff_barrier_plus_pmr', 'constructed:sunset_clauses_and_performance_criteria_proxy']
...
## Estimate
- _Error:_ no treatment variable loaded; missing: ['constructed:exports_to_gdp_plus_export_sophistication', 'constructed:tariff_rate_plus_non_tariff_barrier_plus_pmr', 'constructed:sunset_clauses_and_performance_criteria_proxy']
...
_Generated by `scripts/run_panel_fe.py` at 2026-05-02T15:58:51+00:00_