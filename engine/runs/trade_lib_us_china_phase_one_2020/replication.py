#!/usr/bin/env python3
"""Replication wrapper for `trade_lib_us_china_phase_one_2020`.
...
directly reproducible from engine/runs/trade_lib_us_china_phase_one_2020/.
"""
...
HYPOTHESIS_ID = 'trade_lib_us_china_phase_one_2020'
