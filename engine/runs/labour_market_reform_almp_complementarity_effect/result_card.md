...
**Verdict:** INCONCLUSIVE_DATA_PENDING — no outcome variable loaded; missing: ['world_bank_wdi:SL.UEM.LTRM.ZS', 'world_bank_wdi:SL.UEM.TOTL.ZS', 'wid:gini_post_tax']
...
## Estimate
- _Error:_ no outcome variable loaded; missing: ['world_bank_wdi:SL.UEM.LTRM.ZS', 'world_bank_wdi:SL.UEM.TOTL.ZS', 'wid:gini_post_tax']

## Variables resolved

### Variables missing data
- `world_bank_wdi:SL.UEM.LTRM.ZS` (outcome, name=unemployment_duration_share_long_term) — vintage not on disk
- `world_bank_wdi:SL.UEM.TOTL.ZS` (outcome, name=unemployment_rate) — vintage not on disk
...
- `world_bank_wdi:NY.GDP.PCAP.KD` (controls, name=log_gdp_per_capita) — vintage not on disk
