#!/usr/bin/env python3
"""Replication wrapper for `gfc_contraction_depth_liberalised_vs_state_managed_systems`.
...
HYPOTHESIS_ID = 'gfc_contraction_depth_liberalised_vs_state_managed_systems'
