...
**Verdict:** INCONCLUSIVE_DATA_PENDING — treatment 'liberalised_financial_system_indicator' not loaded; missing: ['constructed: indicator = 1 for USA, GBR, IRL, ISL (liberalised financial systems pre-2007); 0 for CHN, VNM, IND (state-managed credit allocation, large state-bank share). Coding from Fraser EFW financial-freedom subindex deltas + IMF Financial Development Index.', 'fraser_efw:area_3']
...
## Estimate
- _Error:_ treatment 'liberalised_financial_system_indicator' not loaded; missing: ['constructed: indicator = 1 for USA, GBR, IRL, ISL (liberalised financial systems pre-2007); 0 for CHN, VNM, IND (state-managed credit allocation, large state-bank share). Coding from Fraser EFW financial-freedom subindex deltas + IMF Financial Development Index.', 'fraser_efw:area_3']

## Variables resolved
- `world_bank_wdi:NY.GDP.MKTP.KD` → log_real_gdp (outcome, publisher=world_bank_wdi, n=14131)
- `world_bank_wdi:NY.GDP.MKTP.KD.ZG` → cumulative_gdp_decline_2007_2010 (outcome, publisher=world_bank_wdi, n=13961)
...
- `constructed: indicator = 1 for USA, GBR, IRL, ISL (liberalised financial systems pre-2007); 0 for CHN, VNM, IND (state-managed credit allocation, large state-bank share). Coding from Fraser EFW financial-freedom subindex deltas + IMF Financial Development Index.` (treatment, name=liberalised_financial_system_indicator) — vintage not on disk
