#!/usr/bin/env python3
"""Replication wrapper for `patent_thicket_intervention_drag`.
...
directly reproducible from engine/runs/patent_thicket_intervention_drag/.
"""
...
HYPOTHESIS_ID = 'patent_thicket_intervention_drag'
