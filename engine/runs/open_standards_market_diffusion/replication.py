#!/usr/bin/env python3
"""Replication wrapper for `open_standards_market_diffusion`.
...
directly reproducible from engine/runs/open_standards_market_diffusion/.
"""
...
HYPOTHESIS_ID = 'open_standards_market_diffusion'
