# Result card — local_panel_sprint_government_spending_gdp_pc_growth_20260503

**Verdict:** SUPPORTED — coef=-0.2569 (sign matches claim -), p=1.52e-09

## Pre-registration
- **Claim:** Across a pre-registered panel of OECD and major emerging-market economies from 1996 to 2023, larger government-expenditure shares predict slower real GDP per capita growth after country and year fixed effects and basic macro controls. This sprint test uses only local vintages and does not create school-scoreboard links.
...
- **Falsification test:** panel_fe_local_panel_sprint_government_spending_gdp_pc_growth_20260503
