#!/usr/bin/env python3
"""Replication wrapper for `market_competition_patent_quality`.
...
directly reproducible from engine/runs/market_competition_patent_quality/.
"""
...
HYPOTHESIS_ID = 'market_competition_patent_quality'
