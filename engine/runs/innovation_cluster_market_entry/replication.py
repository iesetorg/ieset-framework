#!/usr/bin/env python3
"""Replication wrapper for `innovation_cluster_market_entry`.
...
directly reproducible from engine/runs/innovation_cluster_market_entry/.
"""
...
HYPOTHESIS_ID = 'innovation_cluster_market_entry'
