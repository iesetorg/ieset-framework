#!/usr/bin/env python3
"""Replication wrapper for `fuel_subsidy_reform_qol_long_run`.
...
directly reproducible from engine/runs/fuel_subsidy_reform_qol_long_run/.
"""
...
HYPOTHESIS_ID = 'fuel_subsidy_reform_qol_long_run'
