...
## Comparison
- _Error:_ no outcome variable loaded; missing: ["constructed: zero events documented for federal dollar-denominated obligations 1971-08-15 to 2024-12-31; manually coded from Moody's-S&P-Fitch sovereign-default tables", 'academic:bloomberg_cds', 'fred:auction_results; manual: TreasuryDirect auction tables']
...
- `fred:GFDEGDQ188S` (treatment, name=gross_federal_debt_pct_gdp)
- `fred:A091RC1Q027SBEA; fred:GDP` (treatment, name=net_interest_pct_gdp)
...
- `fred:DTWEXBGS` (controls, name=dxy_dollar_index)
