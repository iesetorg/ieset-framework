...
**Verdict:** INCONCLUSIVE_DATA_PENDING — outcome 'poverty_headcount_rate_indec_eph' not loaded; missing: ['indec:eph_pobreza', 'indec:ripte']
...
## Estimate
- _Error:_ outcome 'poverty_headcount_rate_indec_eph' not loaded; missing: ['indec:eph_pobreza', 'indec:ripte']
...
- `constructed: indicator = 1 for ARG from 2023-12 (Milei inauguration).` (treatment, name=milei_shock_therapy_break)
