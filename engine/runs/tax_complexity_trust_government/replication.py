#!/usr/bin/env python3
"""Replication wrapper for `tax_complexity_trust_government`.
...
directly reproducible from engine/runs/tax_complexity_trust_government/.
"""
...
HYPOTHESIS_ID = 'tax_complexity_trust_government'
