...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `chicago_monetarism` | positive_signal | positive_lean | 20.8 | ±5.0 | 34.5 | 20 | 124 | 32 | 30 | 1 | 12 | 49 | 8 |
| `ordoliberal` | positive_signal | positive_lean | 16.5 | ±5.0 | 28.0 | 17 | 139 | 35 | 22 | 0 | 18 | 64 | 8 |
| `austrian` | positive_signal | positive_lean | 16.2 | ±5.0 | 26.5 | 14 | 128 | 31 | 25 | 0 | 17 | 55 | 6 |
| `classical_liberal` | positive_signal | positive_lean | 15.2 | ±5.0 | 23.5 | 13 | 154 | 38 | 22 | 1 | 25 | 68 | 9 |
| `developmentalism` | positive_signal | positive_lean | 11.0 | ±5.0 | 41.5 | 39 | 124 | 43 | 5 | 0 | 4 | 72 | 9 |
| `new_keynesian` | too_close_to_call | positive_lean | 5.0 | ±5.0 | 13.5 | 7 | 119 | 14 | 13 | 0 | 7 | 85 | 13 |
| `empirical_pragmatist` | too_close_to_call | positive_lean | 4.8 | ±5.0 | 7.5 | 5 | 123 | 12 | 5 | 0 | 7 | 99 | 8 |
| `institutionalism` | too_close_to_call | positive_lean | 3.4 | ±5.0 | 10.0 | 6 | 122 | 12 | 8 | 0 | 6 | 96 | 11 |
| `mmt` | too_close_to_call | negative_lean | -1.1 | ±5.0 | 5.5 | 8 | 122 | 26 | 11 | 16 | 18 | 51 | 12 |
| `marxist_leninist` | too_close_to_call | negative_lean | -1.6 | ±5.0 | 4.0 | 5 | 120 | 21 | 16 | 18 | 16 | 49 | 15 |
| `post_keynesian` | too_close_to_call | negative_lean | -1.8 | ±5.0 | 3.5 | 6 | 121 | 25 | 12 | 17 | 19 | 48 | 12 |
| `eco_socialist` | too_close_to_call | negative_lean | -2.1 | ±5.0 | 5.5 | 6 | 120 | 24 | 15 | 16 | 18 | 47 | 16 |
| `marxian` | too_close_to_call | negative_lean | -2.9 | ±5.0 | 0.0 | 0 | 122 | 22 | 16 | 16 | 22 | 46 | 14 |
| `democratic_socialist` | too_close_to_call | negative_lean | -3.4 | ±5.0 | 1.5 | 2 | 122 | 22 | 16 | 17 | 20 | 47 | 17 |
| `social_democratic` | too_close_to_call | negative_lean | -3.4 | ±5.0 | 1.5 | 3 | 121 | 21 | 14 | 17 | 18 | 51 | 12 |
| `market_socialist` | too_close_to_call | negative_lean | -3.9 | ±5.0 | 1.5 | 2 | 119 | 21 | 15 | 16 | 19 | 48 | 16 |
| `degrowth` | too_close_to_call | negative_lean | -4.8 | ±5.0 | -3.5 | -2 | 119 | 13 | 13 | 16 | 15 | 62 | 14 |
...
- `degrowth`: signal=too_close_to_call; lean=negative_lean; q-net=-4.8; raw-net=-3.5; q-band=±5.0; supports=13; partial+=13; partial-=16; refutes=15; neutral=62; untested=14.
- `eco_socialist`: signal=too_close_to_call; lean=negative_lean; q-net=-2.1; raw-net=5.5; q-band=±5.0; supports=24; partial+=15; partial-=16; refutes=18; neutral=47; untested=16.
...
- `market_socialist`: signal=too_close_to_call; lean=negative_lean; q-net=-3.9; raw-net=1.5; q-band=±5.0; supports=21; partial+=15; partial-=16; refutes=19; neutral=48; untested=16.
- `marxian`: signal=too_close_to_call; lean=negative_lean; q-net=-2.9; raw-net=0.0; q-band=±5.0; supports=22; partial+=16; partial-=16; refutes=22; neutral=46; untested=14.
...
- `mmt`: signal=too_close_to_call; lean=negative_lean; q-net=-1.1; raw-net=5.5; q-band=±5.0; supports=26; partial+=11; partial-=16; refutes=18; neutral=51; untested=12.
- `post_keynesian`: signal=too_close_to_call; lean=negative_lean; q-net=-1.8; raw-net=3.5; q-band=±5.0; supports=25; partial+=12; partial-=17; refutes=19; neutral=48; untested=12.
- `social_democratic`: signal=too_close_to_call; lean=negative_lean; q-net=-3.4; raw-net=1.5; q-band=±5.0; supports=21; partial+=14; partial-=17; refutes=18; neutral=51; untested=12.
