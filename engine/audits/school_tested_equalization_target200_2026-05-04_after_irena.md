...
| `developmentalism` | 123 | 7 | 7 | 0 | 77 | 7 | 70 | needs_successful_rerun (6), needs_run_dir (1) | regulatory.trade_openness (2), fiscal.sectoral_subsidy (1), fiscal.tax_capital (1), regulatory.energy_supply_security (1), fiscal.tax_progressivity (1) |
...
| `institutionalism` | 124 | 9 | 9 | 0 | 76 | 9 | 67 | needs_successful_rerun (8), needs_run_dir (1) | institutional.rule_of_law (4), institutional.property_rights (1), fiscal.tax_capital (1), regulatory.energy_supply_security (1), fiscal.tax_progressivity (1) |
...
| `developmentalism` | 15 | `nova_industria_brasil_export_discipline_pattern_effect` | `needs_run_dir` | `regulatory.trade_openness` | `-` |
