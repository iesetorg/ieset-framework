...
| `marxian` | too_close_to_call | negative_lean | -3.9 | ±5.0 | 0.0 | 0 | 126 | 24 | 16 | 16 | 24 | 46 | 13 |
| `mmt` | too_close_to_call | negative_lean | -4.1 | ±5.0 | 1.5 | 4 | 125 | 25 | 11 | 16 | 21 | 52 | 11 |
| `marxist_leninist` | too_close_to_call | negative_lean | -4.1 | ±5.0 | 1.0 | 2 | 120 | 20 | 16 | 18 | 18 | 48 | 15 |
| `social_democratic` | too_close_to_call | negative_lean | -4.9 | ±5.0 | -0.5 | 0 | 137 | 27 | 16 | 17 | 27 | 50 | 12 |
| `market_socialist` | negative_signal | negative_lean | -5.4 | ±5.0 | 0.5 | 1 | 124 | 23 | 15 | 16 | 22 | 48 | 15 |
| `democratic_socialist` | negative_signal | negative_lean | -5.9 | ±5.0 | -1.5 | -1 | 122 | 21 | 16 | 17 | 22 | 46 | 17 |
...
- `democratic_socialist`: signal=negative_signal; lean=negative_lean; q-net=-5.9; raw-net=-1.5; q-band=±5.0; supports=21; partial+=16; partial-=17; refutes=22; neutral=46; untested=17.
- `market_socialist`: signal=negative_signal; lean=negative_lean; q-net=-5.4; raw-net=0.5; q-band=±5.0; supports=23; partial+=15; partial-=16; refutes=22; neutral=48; untested=15.
- `marxian`: signal=too_close_to_call; lean=negative_lean; q-net=-3.9; raw-net=0.0; q-band=±5.0; supports=24; partial+=16; partial-=16; refutes=24; neutral=46; untested=13.
- `marxist_leninist`: signal=too_close_to_call; lean=negative_lean; q-net=-4.1; raw-net=1.0; q-band=±5.0; supports=20; partial+=16; partial-=18; refutes=18; neutral=48; untested=15.
...
- `social_democratic`: signal=too_close_to_call; lean=negative_lean; q-net=-4.9; raw-net=-0.5; q-band=±5.0; supports=27; partial+=16; partial-=17; refutes=27; neutral=50; untested=12.

## Marxist-Cluster Readout

- `marxian`: signal=too_close_to_call; q-net=-3.9; raw-net=0.0; q-band=±5.0; supports=24; partial+=16; partial-=16; refutes=24; neutral=46; untested=13.
- `marxist_leninist`: signal=too_close_to_call; q-net=-4.1; raw-net=1.0; q-band=±5.0; supports=20; partial+=16; partial-=18; refutes=18; neutral=48; untested=15.
