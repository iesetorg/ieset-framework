# Steelman — market_order_trade_openness_high_tech_exports_panel

The strongest objection is that trade openness may proxy for income level, administrative
capacity, geography, colonial history, or global-cycle exposure rather than the competition, specialization, and market-size channels itself.
