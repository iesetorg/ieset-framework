# Steelman - market_order_government_consumption_private_investment_share_panel

The strongest objection is that government final consumption expenditure as a share of GDP may proxy for income level, administrative
capacity, political history, commodity exposure, or global-cycle timing rather than the resource-crowding, bureaucratic-consumption, and private-sector displacement channels
itself. Country and year fixed effects reduce some bias, but they do not prove causality.

A second objection is reverse causality: countries with higher private fixed-investment shares may find it easier to
