# Steelman - market_order_capital_account_openness_high_tech_exports_panel
...
A second objection is reverse causality: countries with higher high-technology export intensity may find it easier to
