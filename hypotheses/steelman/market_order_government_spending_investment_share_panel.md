# Steelman — market_order_government_spending_investment_share_panel

The strongest objection is that government expenditure as a share of GDP may proxy for income level, administrative
capacity, geography, colonial history, or global-cycle exposure rather than the crowding-out, tax-expectation, and discretionary-allocation channels itself.
The registered panel fixed-effects design reduces pure cross-sectional bias, but it does not prove causality.

A second objection is reverse causality: countries with higher private and total investment shares may find it easier to
